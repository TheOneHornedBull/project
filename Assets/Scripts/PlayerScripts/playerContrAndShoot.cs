...
public class playerContrAndShoot : MonoBehaviour 
{

	public float maxDistance = 10;			// 10
	...
	void FixedUpdate()
	{
		...
		body.position = Vector3.Lerp(transform.position, targetPosition + new Vector3 (0,0.8f,0), easingTime);
	}
